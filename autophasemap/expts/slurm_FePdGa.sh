...
#SBATCH --job-name=FePdGa
#SBATCH --account=cheme
#SBATCH --partition=compute
#SBATCH --nodes=16
#SBATCH --time=24:00:00
#SBATCH --mem=128G
#SBATCH --output=./hyak/FeGaPd_pred.out
#SBATCH --error=./hyak/FeGaPd_err.out
...
python3 -u ./FeGaPd/FeGaPd_autophasemap.py > ./hyak/FeGaPd_logging.out
echo "All Done!"
exit
